...
export function PatientDetailPDF({ detailPatient }: { detailPatient: PatientDataModel }) {
        ...
        <View style={styles.table}>
          ...
          {controllHistory.map((row: any, idx: number) => (
            <View style={styles.tableRow} key={row.id}>
              ...
              <Text style={styles.tableCell}>{formatTanggal(row.date instanceof Date ? row.date.toISOString() : row.date)}</Text>
