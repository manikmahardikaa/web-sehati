...
import DownloadReportControlModal from "@/app/components/common/program-wilayah/modal/history-control-and-medication/control";
import DownloadReportMedicationModal from "@/app/components/common/program-wilayah/modal/history-control-and-medication/medication";
        ...
        <>
          ...
          >
            ...
            <div style={{ display: "flex", gap: 12 }}>
              <CustomButton title="Pilih Laporan" />
              <CustomButton
                title="Unduh Laporan"
    ...
    },
    {
      ...
      children: (
        <>
          ...
          <ExpandableHistoryTable type="medication" patients={patients} />
