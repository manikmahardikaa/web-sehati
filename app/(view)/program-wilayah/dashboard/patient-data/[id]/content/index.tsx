import { usePatient } from "@/app/hooks/program-wilayah/patient";
  ...
  const controlColumns = [
    {
      ...
      width: 38,
      render: (_: ControllHistoryDataModel, __: ControllHistoryDataModel, idx: number) => idx + 1,
    },
    {
  ...
  const medicationColumns = [
    {
      ...
      align: "center" as const,
      width: 38,
      render: (_: MedicationHistoryDataModel, __: MedicationHistoryDataModel, idx: number) => idx + 1,
    },
    {
      title: "Tanggal Kontrol",
      dataIndex: "date",
    ...
    >
      ...
      >
        ...
        <div style={{ padding: "2px 14px 10px 14px", background: "#fff" }}>
          <InfoField label="Nama Lengkap" value={detailPatient.name || "-"} />
          <InfoField label="Alamat" value={detailPatient.street || "-"} />
          <InfoField
            label="Tanggal Lahir"
            value={formatTanggal(detailPatient.birth_date.toString()) || "-"}
          />
          <InfoField
            label="No. WhatsApp"
      ...
      <Row gutter={18}>
        <Col xs={24} md={12}>
          <Title level={5} style={{ marginBottom: 8, fontWeight: 600, textAlign: "center" }}>
            Jadwal Kontrol
          </Title>
          <Card
            style={{
